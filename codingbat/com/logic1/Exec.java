...
public class Exec {
	...
	public boolean shareDigit(int a, int b) {
		...
		int bDiv = b/10;
		int bMod = b%10;
		return (aDiv==bDiv||aDiv==bMod||aMod==bDiv||aMod==bMod);
	 ...
	 * Otherwise 
	 * if the ab sum is exactly 10 more than either bc or ac sums, 
	 ...
	 * Otherwise if they are all the same, 
	 * the result is 5. 
	 ...
	 * then the return the smaller value. However, 
	 * in all cases, if the two values are the same, 
	 * return 0. 
	...
	public int maxMod5(int a, int b) {
		...
		int remainderA = a % 5;
		int remainderB = b % 5;
		if(remainderA==remainderB) return Math.min(a,b);
	 ...
	 * if one of them is 10 or more less than one of the others. 
	 * 
	...
	public boolean lessBy10(int a, int b, int c) {
		return (Math.max(a, b)-Math.min(a, b)>=10) || 
				(Math.max(a, c)-Math.min(a, c)>=10) || 
				(Math.max(b, c)-Math.min(b, c)>=10);
		/*
		 *  Solution
	...
	/*
	 * Given three ints, a b c, return true 
	 * if they are in strict increasing order, 
	 * such as 2 5 11, or 5 6 7, but not 6 5 7 or 5 5 7. 
	 * However, with the exception that 
	 ...
	 * 
	 * A party is good (1) 
	 * if both tea and candy are at least 5. 
	 * However, 
	 ...
	 * if it is your mom calling. In all cases, 
	...
	/*
	 * Return true 
	 * if the given non-negative number is 1 or 2 less than a multiple of 20. 
	...
	public boolean old35(int n) {
		return ((n%3==0 && n%15!=0) || (n%5==0 && n%15!=0));
	}
	/*
	 * Return true if the given non-negative number 
	...
	public boolean cigarParty(int cigars, boolean isWeekend) {
		...
		if((cigars>=40 && cigars<=60) 
				||(isWeekend && cigars>=40)) isHappy = true;
